...
var Schema = mongoose.Schema;
   ...
   var StudentsSchema = mongoose.Schema({
      ...
      Year: { type: Schema.Types.ObjectId, ref: 'YearlyBatches', required : true },
      Semester: { type: Schema.Types.ObjectId, ref: 'YearlyBatches', required : true },
      Section: { type: Date, required : true },
