module.exports = function(app) {
   ...
   var Controller = require('./../../Controllers/Admin-Panel/Students.controller');
   ...
   app.post('/API/Students/DepartmentBased_StudentsList', Controller.DepartmentBased_StudentsList);
